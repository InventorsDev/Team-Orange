  ...
  const getIsformChanged = () => {
    if (retrievedValues) {
      return (
        ...
        (state.gender !== retrievedValues.gender && state.gender !== "") ||
  ...
  return (
    <div className="EditProfile">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          <input type="email" placeholder="" value={state.email} disabled />
          <div className="sideImages">
            <img src={email} alt="" />
          </div>
        </fieldset>
      ...
      {message.string ? (
        <p className={message.status ? "success" : "fail"}>{message.string}</p>
      ) : null}
      {isFormSubmitted ? (
